                                        ...
                                        if(DATA_Packet_Control==0x08)TIMER1s=1700;    //500ms(stop)+100ms(NOP)+1100ms(open)
                                            ...
                                            if(FLAG_HA_ERR==1)//表示百叶窗完全关闭
                                            {
                                                ...
                                                switch(DATA_Packet_Control){
                                                    case 0x41:
                                                             TIME_angle_n=60*3-30;//250;   //3回
                                                             break;
                                                    case 0x42:
                                                             TIME_angle_n=60*4-30;//350;   //4回
                                                             break; 
                                                    case 0x43:
                                                             TIME_angle_n=60*5-30;//450;   //5回
                                                             break; 
                                                    case 0x44:
                                                             TIME_angle_n=60*6-30;//550;  //6回
                                                             break;  
                                                    case 0x45:
                                                             TIME_angle_n=60*8-30;//750;  //8回
                                                             break;   
                                                    case 0x46:
                                                             TIME_angle_n=60*10-30;//950; //10回
                                                             break;          
                                                }
