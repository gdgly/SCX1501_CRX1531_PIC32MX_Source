...
#define NVMOP_WORD_PGM          0x4001//0x4001      // Word program operation
#define NVMOP_PAGE_ERASE        0x4004//0x4004      // Page erase operation
#define NVMOP_ROW_PGM           0x4003//0x4003      // Row program operation
#define NVMOP_NOP               0x4000//0x4000      // NOP operation
